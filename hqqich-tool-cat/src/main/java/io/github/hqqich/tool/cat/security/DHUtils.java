...
public class DHUtils {
	...
	public static Map<String, Object> initKey(int keySize) {
		try {
			...
			keyMap.put(DH_PUBLIC_KEY, (DHPublicKey) keyPair.getPublic());
			keyMap.put(DH_PRIVATE_KEY, (DHPrivateKey) keyPair.getPrivate());
			return keyMap;
		} catch (Exception e) {
	 ...
	 * @return
	 */
	public static Map<String, Object> initKey(byte[] publicKey) {
		try {
	...
	public static byte[] getPublicKey(Map<String, Object> keyMap) {
		DHPublicKey key = (DHPublicKey) keyMap.get(DH_PUBLIC_KEY);
	...
	public static byte[] getPrivateKey(Map<String, Object> keyMap) {
		DHPrivateKey key = (DHPrivateKey) keyMap.get(DH_PRIVATE_KEY);
		return key.getEncoded();
	}
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("甲方公钥 : " + StringByteHexUtils.byteArrayToHexString(publicKey1));
		System.out.println("甲方私钥 : " + StringByteHexUtils.byteArrayToHexString(privateKey1));
		...
		System.out.println("乙方本地密钥 : " + StringByteHexUtils.byteArrayToHexString(secretKey2));
